...
plt.hist(test_RMSE_list_bin1, bins=np.arange(9.0,19.0,0.5), edgecolor='k', histtype ='bar', density=True)
...
plt.hist(train_RMSE_list_bin1, bins=np.arange(9.0,19.0,0.5), color='orange', edgecolor='k', histtype ='bar',
