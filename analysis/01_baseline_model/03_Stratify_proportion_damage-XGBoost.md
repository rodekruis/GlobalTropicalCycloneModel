...
for i in range(20):
    ...
    #XGBoost before solving problem of overfitting
...
xgb = XGBRegressor(n_estimators=100, max_depth=4, learning_rate=0.1, gamma=1, reg_lambda=0.1, colsample_bytree=0.8, random_state=42)
