...
! gdalinfo "%STORM_DATA_DIR%/analysis/02_new_model_input/04_topography/input/srtm/phl_merged_srtm.tif"
```

```python
## slope
## when running, make sure it is on the same line.
#! gdaldem slope  -s 111120 -co COMPRESS=DEFLATE -co ZLEVEL=9
# "%STORM_DATA_DIR%/analysis/02_new_model_input/04_topography/input/srtm/phl_merged_srtm.tif"
# "%STORM_DATA_DIR%/analysis/02_new_model_input/04_topography/input/srtm/phl_slope_gdaldem.tif"
# -compute_edges
```
...
# "%STORM_DATA_DIR%/analysis/02_new_model_input/04_topography/input/srtm/phl_merged_srtm.tif"
# "%STORM_DATA_DIR%/analysis/02_new_model_input/04_topography/input/srtm/phl_tri_gdaldem.tif"
#  -compute_edges
```
