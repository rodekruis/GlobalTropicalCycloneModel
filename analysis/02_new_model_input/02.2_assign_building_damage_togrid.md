...
# duplicates removed and kep only the first value
# for each municipality, typhoon and year
...
# Not all municipalities in the damage data can be found in the admin 3 shapefile.
...
```python
## Section describing the merging of the
# north and south buildings from HOTOSM shapefile
