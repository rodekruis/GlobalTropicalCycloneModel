...
plt.hist(test_RMSE_list, bins=np.arange(10.5,20.0,0.5), edgecolor='k', histtype ='bar', density=True)
...
plt.hist(train_RMSE_list, bins=np.arange(10.5,20.0,0.5), color='orange', edgecolor='k', histtype ='bar',density=True, alpha=0.7)
